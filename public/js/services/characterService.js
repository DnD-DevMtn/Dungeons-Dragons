function characterService($http, $state, userService) {
  ...
  this.finalStats = (str, dex, con, int, wis, cha, room, campaign) => {
    ...
    currentCharacter.money.gold = 50;
    if(currentCharacter.classType === "Fighter"){
      const classId = "5818cf737e79500420928e5d";
      ...
      const classId = "5818cff07e79500420928e5e";
      ...
      const classId = "581b56450be6891a5843f1c1";
      ...
      const classId = "581b5cc00be6891a5843f1c2";
    ...
    getBaseAttack(classId).then(results => {
  ...
  function getBaseAttack(classId) {
    return $http.get(`/api/classes/${classId}`).then(class => {
      console.log(class);
    })
  }
}
